    ...
    return {
        ...
        "themes": {
            "regular": {
                ...
                "centers": [[90, 70], [110, 70], [130, 70], [150, 70], [170, 70], [190, 70], [210, 70], [90, 90], [110, 90], [130, 90], [150, 90], [170, 90], [190, 90], [210, 90], [90, 110], [110, 110], [130, 110], [150, 110], [170, 110], [190, 110], [210, 110], [90, 130], [110, 130], [130, 130], [150, 130], [170, 130], [190, 130], [210, 130], [90, 150], [110, 150], [130, 150], [150, 150], [170, 150], [190, 150], [210, 150],
                            [90, 50], [110, 50], [130, 50], [150, 50], [170, 50], [190, 50], [210, 50], [90, 70], [110, 70], [130, 70], [150, 70], [170, 70], [190, 70], [210, 70], [90, 90], [110, 90], [130, 90], [150, 90], [170, 90], [190, 90], [210, 90], [90, 110], [110, 110], [130, 110], [150, 110], [170, 110], [190, 110], [210, 110], [90, 130], [110, 130], [130, 130], [150, 130], [170, 130], [190, 130], [210, 130], [90, 140], [110, 140], [130, 140], [150, 140], [170, 140], [190, 140], [210, 140]
                        ],
                "background": "stormyseas/fullboard.svg",
                "charImages": {
                    "W": {"image":"stormyseas/wave.svg", "scale": "100"},
                    "B": {"image":"stormyseas/blueboat.svg", "scale": "100"},
                    "R": {"image":"stormyseas/redboat.svg", "scale": "100"},
                },
                "arrowWidth": 2,
    ...
    return {
        ...
        "themes": {
            "regular": {
                ...
                "charImages": {
                    "a": {"image": "dshogi/sky_elephant_2.svg", "scale": 100},
                    "A": {"image": "dshogi/forest_elephant_2.svg", "scale": 100},
                    "b": {"image": "dshogi/sky_giraffe_2.svg", "scale": 100},
                    "B": {"image": "dshogi/forest_giraffe_2.svg", "scale": 100},
                    "c": {"image": "dshogi/sky_chick.svg", "scale": 100},
                    "C": {"image": "dshogi/forest_chick.svg", "scale": 100},
                    "d": {"image": "dshogi/sky_chick_2.svg", "scale": 100},
                    "D": {"image": "dshogi/forest_chick_2.svg", "scale": 100},
                    "e": {"image": "dshogi/sky_elephant.svg", "scale": 100},
                    "E": {"image": "dshogi/forest_elephant.svg", "scale": 100},
                    "g": {"image": "dshogi/sky_giraffe.svg", "scale": 100},
                    "G": {"image": "dshogi/forest_giraffe.svg", "scale": 100},
                    "h": {"image": "dshogi/sky_hen.svg", "scale": 100},
                    "H": {"image": "dshogi/forest_hen.svg", "scale": 100},
                    "l": {"image": "dshogi/sky_lion.svg", "scale": 100},
                    "L": {"image": "dshogi/forest_lion.svg", "scale": 100},
                    "0": {"image": "dshogi/giraffe_move_token.svg", "scale": 50},
                    "1": {"image": "dshogi/elephant_move_token.svg", "scale": 50},
                    "2": {"image": "dshogi/chick_move_token.svg", "scale": 50},
                },
                "arrowWidth": 2,
                "sounds": {
                    "x": "general/slide.mp3",
